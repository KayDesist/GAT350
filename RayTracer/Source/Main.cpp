...
int main(int argc, char* argv[])
{
	...
	std::shared_ptr<Material> green = std::make_shared<Metal>(color3_t{ 0, 1, 0 }, 0.5f);
	...
	while (!quit)
	{
		...
		scene.Render(framebuffer, camera, 100, 100); // last two ints control samples and depth
